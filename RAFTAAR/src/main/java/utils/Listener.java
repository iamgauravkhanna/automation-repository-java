...
public class Listener implements ITestListener, ISuiteListener, IInvokedMethodListener {
	...
	public void onStart(ISuite arg0) {
		...
		LogUtils.info("onStart ISuite : About to begin executing Suite " + arg0.getName());
	...
	public void onFinish(ISuite arg0) {
		...
		LogUtils.info("onFinish ISuite : About to end executing Suite " + arg0.getName());
	...
	public void onStart(ITestContext arg0) {
		...
		LogUtils.info("onStart ITestContext : About to begin executing Test " + arg0.getName());
