...
public class ExcelUsingApachePOI {
	...
	public ExcelUsingApachePOI(String path) {
	...
	public static void main(String arg[]) throws IOException {
		...
		ExcelUsingApachePOI datatable = null;

		datatable = new ExcelUsingApachePOI(System.getProperty("user.dir")
				+ "\\src\\config\\Core.xlsx");
