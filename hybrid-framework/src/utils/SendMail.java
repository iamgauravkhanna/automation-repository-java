...

{
	...
	{
		String path = "C:\\gaurav\\sample.txt";

		String[] to = { "gaurav.khanna@hcentive.com" };
		String[] cc = {};
		String[] bcc = {};

		SendMail.sendMail("iamgauravkhanna", "Usergrv*()890", "smtp.gmail.com",
				"465", "true", "true", true, "javax.net.ssl.SSLSocketFactory",
				"false", to, cc, bcc, "Subject", "Entering Some Content", path,
				reportFileName);
	}
